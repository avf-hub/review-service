...
import static ru.javaops.cloudjava.reviewservice.testutil.TestUtils.compareDefaultMenuInfo;
...
class ReviewServiceImplTest extends BaseIntegrationTest {
    ...
    void getRatedReviewsForMenu_returnsCorrectResponse_whenMenuHasReviews() {
        ...
        RatedReviewsResponse response = reviewService.getRatedReviewsForMenu(MENU_TEN, SortBy.DATE_ASC, 0, 5);
